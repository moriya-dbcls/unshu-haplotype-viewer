(() => {
  ...
  const I18N = {
    ja: {
      ...
      loadedBadge: "温州アセンブリ {version} · GFA投影", loading: "温州アセンブリ {version}を使ったChr1–9 GFAを読み込み中", loaded: "温州アセンブリ {version}を使ったChr1–9 GFAを表示中", loadToast: "温州アセンブリ {version}を使ったChr1–9 GFA投影データを読み込みました", pathDivergence: "経路差候補",
    ...
    en: {
      ...
      loadedBadge: "Satsuma assembly {version} · GFA projection", loading: "Loading the Chr1–9 GFA built with Satsuma assembly {version}", loaded: "Showing the Chr1–9 GFA built with Satsuma assembly {version}", loadToast: "Loaded the Chr1–9 GFA projection built with Satsuma assembly {version}", pathDivergence: "Path divergence candidate",
